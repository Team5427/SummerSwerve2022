...
public final class Constants {
    public static final class DriveConstants {
        ...
        private static final Translation2d kFrontLeftModulePosition = new Translation2d(kWheelBase / 2,
                kTrackWidth / 2);
        private static final Translation2d kFrontRightModulePosition = new Translation2d(kWheelBase / 2,
                -kTrackWidth / 2);
        private static final Translation2d kBackLeftModulePosition = new Translation2d(-kWheelBase / 2,
                kTrackWidth / 2);
        private static final Translation2d kBackRightModulePosition = new Translation2d(-kWheelBase / 2,
                -kTrackWidth / 2);
        ...
        public static final double kMaxSpeedMetersPerSecond = 3.657;
        public static final double kMaxChassisAngularSpeedRadiansPerSecond = 10.345; // should be 10.345
        ...
        public static final double kXTargetTrackCoefficient = 0.33333333;
        public static final double kYTargetTrackCoefficient = 0.33333333;
    }
    ...
    public static final class ModuleConstants {
        ...
        public static final double kPModuleDriveController = 1.8;
    ...
    public static final class AutoConstants {
        ...
        public static final double kPXController = 7.75;
        public static final double kPYController = 7.75;
